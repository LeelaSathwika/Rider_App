...
class ProfileScreen extends StatelessWidget {
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: ListView(
                padding:
                const EdgeInsets.fromLTRB(16, 16, 16, 80), // 👈 bottom padding
                children: [
                  _statsCard(),
  ...
  Widget _tile(IconData icon, String text) => ListTile(
    leading: Icon(icon),
    title: Text(text),
